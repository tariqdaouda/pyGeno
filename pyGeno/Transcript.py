...
from pyGeno.pyGenoObjectBases import *

import rabaDB.fields as rf

from pyGeno.SNP import SNP_INDEL
from pyGeno.Exon import *
from pyGeno.tools import UsefulFunctions as uf

from pyGeno.tools.BinarySequence import NucBinarySequence
...
class Transcript_Raba(pyGenoRabaObject):
    ...
    def _curate(self):
        ...
        self.coding = (have_CDS_start and have_CDS_end)
...
class Transcript(pyGenoRabaObjectWrapper):
    ...
    def _load_data(self):
        ...
        if len(cDNA_str) > 0 and len(cDNA_str) % 3 != 0:
    ...
    def getNucleotideCodon(self, cdnaX1):
        """Returns the entire codon of the nucleotide at pos cdnaX1 in the cdna, and the position of that nucleotide in the codon"""
    ...
    def find(self, sequence):
        """return the position of the first occurrence of sequence"""
    ...
    def findInUTR5(self, sequence):
        """return the position of the first occurrence of sequence in the 5'UTR"""
    ...
    def findInUTR3(self, sequence):
        """return the position of the first occurrence of sequence in the 3'UTR"""
        return self.bin_UTR3.find(sequence)

    def findAllInUTR3(self, sequence):
        """Returns a list of all positions where sequence was found in the 3'UTR"""

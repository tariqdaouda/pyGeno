...
class SegmentTree :
	...
	def addChild(self, segmentTree, index = -1) :
	...
	def intersect(self, x1, x2) :
		"""Returns the all the segments intersected by x1, x2"""
		if x1 > x2 :
			xx1, xx2 = x2, x1
		else :
			xx1, xx2 = x1, x2
		...
		elif (self.x1 == None and self.x2 == None) : #if i'm the root
			for c in self.children :
				ret.extend(c.intersect(x1, x2))
	...
	def getFirstLevelIndexedRegions(self) :
